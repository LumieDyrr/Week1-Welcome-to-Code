...
let exampleSecondWord3 = word3.substring(4, 15);
let exampleThirdWord3 = word3.substring(15, 17);
let exampleFourthWord3 = word3.substring(18, 20);
let exampleFifthhWord3 = word3.substring(20, 25);
...
console.log('Fifth Word: ' + exampleFifthhWord3);
...
let exampleFifthhWord4 = word4.substring(20, 25);
...
let fifthWordLength = exampleFifthhWord4.length;
...
console.log('Four Word: ' + exampleFourthWord4 + ', with length: ' + FourWordLength);
console.log('Fifth Word: ' + exampleFifthhWord4 + ', with length: ' + fifthWordLength);
